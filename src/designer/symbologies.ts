...
export const sampleValueBySymbology: Record<string, string> = {
  QRCode: 'https://labelforge.io',
  MicroQRCode: 'A1B2C3',
  iQRCode: 'https://labelforge.io',
  GS1QRCode: '(01)09501101530003',
  GS1DigitalLinkQRCode: 'https://id.example.com/01/09501101530003',
  DataMatrix: 'ABC123456789',
  GS1DataMatrix: '(01)09501101530003',
  GS1DataMatrixPharma: '(01)09501101530003',
  ...
  ChannelCode: '1234567',
  UCCEAN128: '(01)09501101530003',
  GS1128: '(01)09501101530003',
  GS1128Pharma: '(01)09501101530003',
  UPCE: '01234565',
  UPCEAddon2: '01234565',
  UPCEAddon5: '01234565',
  EAN8: '96385074',
  JAN8: '96385074',
  ISBN13: '978-1-56581-231-4',
  DUN14: '09501101530003',
  ITF14: '09501101530003',
  GS1DataBar: '(01)09501101530003',
  GS1DataBarOmnidirectional: '(01)09501101530003',
  GS1DataBarTruncated: '(01)09501101530003',
  GS1DataBarLimited: '(01)09501101530003',
  GS1DataBarExpanded: '(01)09501101530003',
  GS1DataBarExpandedStacked: '(01)09501101530003',
  GS1DataBarStacked: '(01)09501101530003',
  GS1DataBarStackedOmnidirectional: '(01)09501101530003',
  RSS: '(01)09501101530003',
  EAN8CCAB: '96385074|(10)ABC123',
  EAN13CCAB: '4006381333931|(10)ABC123',
  UPCACCAB: '012345678905|(10)ABC123',
  UPCECCAB: '01234565|(10)ABC123',
  GS1128CCAB: '(01)09501101530003|(10)ABC123',
  GS1128CCC: '(01)09501101530003|(10)ABC123',
  GS1DataBarExpandedCCAB: '(01)09501101530003|(10)ABC123',
  GS1DataBarExpandedStackedCCAB: '(01)09501101530003|(10)ABC123',
  GS1DataBarLimitedCCAB: '(01)09501101530003|(10)ABC123',
  GS1DataBarOmnidirectionalCCAB: '(01)09501101530003|(10)ABC123',
  GS1DataBarStackedCCAB: '(01)09501101530003|(10)ABC123',
  GS1DataBarStackedOmnidirectionalCCAB: '(01)09501101530003|(10)ABC123',
  GS1DataBarTruncatedCCAB: '(01)09501101530003|(10)ABC123',
  AustraliaPost: '5956439111ABA 9',
  DeutschePostIdentcode: '563102430313',
  DeutschePostLeitcode: '21348075016401',
  USPSIntelligentMail: '0123456709498765432101234567891',
  USPSPlanet: '12345678901',
  USPSPostnet: '123456789',
  OPC: '12345',
...
export function getSampleValueForSymbology(value: string): string {
  return sampleValueBySymbology[value] ?? '123456789012'
}
...
export const barcodeSymbologyGroups: SymbologyGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'PDF417 Truncated', value: 'PDF417Truncated', bwip: 'pdf417', notes: 'Rendered as PDF417 preview' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Standard 2-of-5', value: 'Standard2of5', bwip: 'industrial2of5', notes: 'Rendered as 2-of-5 preview' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'GS1 DataBar Stacked Omnidirectional', value: 'GS1DataBarStackedOmnidirectional', bwip: 'databarstackedomni' },
      { label: 'GS1 DataMatrix', value: 'GS1DataMatrix', bwip: 'gs1datamatrix' },
      { label: 'GS1 Composite', value: 'GS1Composite', bwip: 'gs1-cc', supported: false },
      { label: 'Composite', value: 'Composite', bwip: 'gs1-cc', supported: false },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'CEPNet Brasil', value: 'CEPNetBrasil', bwip: 'cepnet', supported: false },
      ...
      { label: 'Korea Post', value: 'KoreaPost', bwip: 'koreapost', supported: false },
      { label: 'Royal Mail 4-State Mailmark Type C', value: 'RoyalMailMailmarkC', bwip: 'mailmark', supported: false },
      { label: 'Royal Mail 4-State Mailmark Type L', value: 'RoyalMailMailmarkL', bwip: 'mailmark', supported: false },
      { label: 'Royal Mail CMDM Mailmark', value: 'RoyalMailCMDMMailmark', bwip: 'mailmark', supported: false },
